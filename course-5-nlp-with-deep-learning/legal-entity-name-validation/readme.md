<div dir="rtl">
# گزارش فنی سامانه پذیرش یا رد اسامی حقوقی  
## مقدمه 
مسأله‌ی اصلی در این پروژه، طراحی و پیاده‌سازی یک سامانه هوشمند برای **پذیرش یا رد اسامی حقوقی پیشنهادی** است. هدف این سامانه آن است که با توجه به مجموعه‌ای از اسامی ثبت‌شده، بتواند تشخیص دهد آیا نام پیشنهادی با قوانین مشخصی بر یکی از اسامی موجود منطبق است یا خیر. در صورت وجود تطابق، نام پیشنهادی رد می‌شود؛ در غیر این صورت، پذیرش خواهد شد.  
...
1. **مرحله اول (Retrieve):**  
   - مدل Bi-Encoder، ۱۰۰ نام مشابه از میان دو میلیون نام ثبت‌شده انتخاب می‌کند.  
2. **مرحله دوم (Rerank):**  

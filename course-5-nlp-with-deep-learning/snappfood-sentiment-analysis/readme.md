<div dir="rtl">
  ...
  # گزارش فنی پروژه تحلیل احساسات کامنت‌های اسنپ‌فود  

## مقدمه  
هدف این پروژه، طراحی و پیاده‌سازی یک راه حل **تحلیل احساسات (Sentiment Analysis)** بر روی کامنت‌های کاربران اسنپ‌فود است. این سامانه با استفاده از روش‌های یادگیری ماشین و یادگیری عمیق، قادر است احساسات موجود در متن کامنت‌ها را در دسته‌های مختلف (مانند happy و sad) تشخیص دهد.  
